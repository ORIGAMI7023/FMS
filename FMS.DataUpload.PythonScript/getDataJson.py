...
xlsx_path = os.path.join(base_dir, "2025简单结构汇总.xlsx")
...
# 导出 JSON 文件import os
output_path = os.path.join(os.path.dirname(__file__), "RevenueRecords_2025.json")
with open(output_path, "w", encoding="utf-8") as f:

    json.dump(records, f, indent=2, ensure_ascii=False)

print(f"✅ 导出成功，共 {len(records)} 条记录。输出文件：RevenueRecords_2025.json")
